...
const RetrofittingWindowsDraughtProofing1 = () => {
    ...
    const [sustainabilityValue, setSustainabilityValue] = React.useState(3);
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">Draught-proofing strips glued to window frames</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                    ...
                    <div className={classes.tabPanelBase}>
                            ...
                            <Grid
                                ...
                                <Grid item sm={11} lg={9}>
                                    <p className="baseText">
                                        A simple, unobtrusive retrofit measure which can improve the thermal performance of
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                ...
                                air movement and retrofit measures to improve the controlled ventilation of the
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">
                                    To prevent uncontrolled air movement (draughts) at the junctions where the
                                    window’s openable parts (casements / sashes) meet the window frame, you can
                                    glue to the frame draught-proofing strips, made from flexible foam. In older
                                    windows, these junctions are commonly prone for either heat to escape the building
                                    or cold air to be blown in, especially where the casements / sashes close no longer
                                    tightly. The occurring draughts depend on the difference in indoor and outdoor air
                                    pressures and wind speed and can cause substantial heat transfer by convection and
                                    discomfort to building users. For example, in wintertime, a strong wind standing on
                                    a building will easily press cold air through the gaps between the frame of a window
                                    and its casements / sashes. If the wind eases off, the potentially higher indoor air
                                    pressure can force warm indoor air out of the window.
                                </p>
                                <p className="overviewText">
                                    Draughts through the junctions of window frame and casement / sash can be significantly
                                    reduced by adding slender, self-adhesive foam sealant strips. These are placed in a continuous
                                    loop into the corners of the window frames, so that they meet the casements / sashes when closed,
                                    thereby sealing any gaps at this junction.
                                </p>
                                <p className="overviewText">
                                    [IMAGE].
                                </p>
                            ...
                            <Grid item id="id2">
                                ...
                                <p className="overviewText">
                                    Draught-proofing strips are very inexpensive retrofit products which, as self-adhesive sealant
                                    strips, can easily be fitted without specialist experience into most window frames. We have
                                    therefore rated this measure as extremely cost effective.
                                </p>
                                <p className="overviewText">
                                    ...
                                    this retrofit measure might achieve as extremely efficient. (Newer windows will normally
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">
                                    Since the draught-proofing strips are generally made of foam, they are made from fossil
                                    fuels and are of limited durability, with a service life of ca. 5 years. Therefore, we
                                    consider this retrofit measure as having conventional sustainability credentials.
                                </p>
                                <p className="overviewText">
...
export default RetrofittingWindowsDraughtProofing1;