  ...
  return (
    <div className={navClasses.join(" ")}
      ...
      <ul style={{ listStyle: 'none' }}>
        ...
        <li className="menu-item"><Link to="id2" spy={true} smooth={true} duration={scrollTime}>Cost effectiviness &#38; energy performance</Link></li>
        <li className="menu-item"><Link to="id3" spy={true} smooth={true} duration={scrollTime}>User comfort, side effects &#38; sustainability</Link></li>
