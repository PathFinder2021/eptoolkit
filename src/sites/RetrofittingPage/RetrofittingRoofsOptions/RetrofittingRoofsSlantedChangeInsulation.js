...
const RetrofittingRoofsSlantedChangeInsulation = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box3Header1', { ns: 'rRoofs' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('changingInsulationTab2text1', { ns: 'rRoofs' })}
                            </p>
                        </TabPanel>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('changingInsulationHeader1text1', { ns: 'rRoofs' })}</p>
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('changingInsulationHeader2text1', { ns: 'rRoofs' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('changingInsulationHeader3text1', { ns: 'rRoofs' })}</p>
                                <p className="overviewText">{t('changingInsulationHeader3text2', { ns: 'rRoofs' })}</p>
                                <p className="overviewText">{t('changingInsulationHeader3text3', { ns: 'rRoofs' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('changingInsulationHeader4text1', { ns: 'rRoofs' })}</p>
                                <p className="overviewText">{t('changingInsulationHeader4text2', { ns: 'rRoofs' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('changingInsulationRelatedLink1', { ns: 'rRoofs' })}
...
export default RetrofittingRoofsSlantedChangeInsulation;