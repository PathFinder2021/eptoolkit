...
const RetrofittingRoofsColdLoftBlownWool = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box2Header1', { ns: 'rRoofs' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('coldLoftHeader1text1', { ns: 'rRoofs' })}</p>
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('coldLoftHeader2text1', { ns: 'rRoofs' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('coldLoftHeader3text1', { ns: 'rRoofs' })}</p>
                                <p className="overviewText">{t('coldLoftHeader3text2', { ns: 'rRoofs' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('coldLoftHeader4text1', { ns: 'rRoofs' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">{t('coldLoftRelatedLink1', { ns: 'rRoofs' })}</p>
                                <p className="overviewText">{t('coldLoftRelatedLink2', { ns: 'rRoofs' })}</p>
                            </Grid>
                        </Grid>
...
export default RetrofittingRoofsColdLoftBlownWool;