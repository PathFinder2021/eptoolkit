...
const RetrofittingRoofsOptions = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('header1', { ns: 'rRoofs' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                            ...
                            <div className={classes.overviewContainer}>
                                ...
                                <Grid
                                    ...
                                    <Grid item xs={12} md={4} className={classes.arrowTextContainer}>
                                        <p className={classes.carouselArrowText}> <ArrowForwardIcon className={classes.arrowIcon} /> Altering and replacing roofs </p>
                                        <p className={classes.carouselText}>
                                            <small>Improving the energy performance of the actual roofs can be effective but isn't always heritage-sensitive.</small></p>
                                ...
                                <Grid
                                    ...
                                    <Grid item xs={12} sm={12} id="id1" >
                                        <Paper
                                            ...
                                            onClick={() => {
                                                redirectTo("retrofittingRoofsColdLoftBlownWool");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id2" >
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${BackgroundImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingRoofsSlantedChangeInsulation");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id3" >
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${BackgroundImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingRoofsSlantedAddInsulation");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id5" >
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${BackgroundImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingRoofsSlantedTape");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
...
export default RetrofittingRoofsOptions;