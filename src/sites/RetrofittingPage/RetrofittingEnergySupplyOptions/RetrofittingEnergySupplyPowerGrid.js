...
import BannerImage from "../../../external/images/energy/powerGrid1.JPG"
...
const RetrofittingEnergySupplyPowerGrid = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box2Header1', { ns: 'rEnergySupply' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('electricityNetworkTab2text1', { ns: 'rEnergySupply' })}
                            </p>
                        </TabPanel>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('electricityNetworkHeader1text1', { ns: 'rEnergySupply' })}</p>
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('electricityNetworkHeader2text1', { ns: 'rEnergySupply' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('electricityNetworkHeader3text1', { ns: 'rEnergySupply' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('electricityNetworkHeader4text1', { ns: 'rEnergySupply' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('electricityNetworkRelatedLink1', { ns: 'rEnergySupply' })}
...
export default RetrofittingEnergySupplyPowerGrid;