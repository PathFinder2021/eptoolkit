...
import BannerImage from "../../../external/images/energy/windTurbine1.JPG"
...
const RetrofittingEnergySupplyGenerator = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box3Header1', { ns: 'rEnergySupply' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('generatorTab2text1', { ns: 'rEnergySupply' })}
                            </p>
                        </TabPanel>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('generatorHeader1text1', { ns: 'rEnergySupply' })}</p>
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('generatorHeader2text1', { ns: 'rEnergySupply' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('generatorHeader3text1', { ns: 'rEnergySupply' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('generatorHeader4text1', { ns: 'rEnergySupply' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('generatorRelatedLink1', { ns: 'rEnergySupply' })}
...
export default RetrofittingEnergySupplyGenerator;