...
import BannerImage from "../../../external/images/energy/transformerSubstation1.JPG"
import BackgroundImage from "../../../external/images/windows/window2.JPG"
import PowerGridImage from "../../../external/images/energy/powerGrid1.JPG"
...
const RetrofittingEnergySupplyOptions = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('header1', { ns: 'rEnergySupply' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                                    ...
                                    <Grid
                                        ...
                                        <Grid item>
                                            <header className="overviewTitle">
                                                {t('box1Header1', { ns: 'rEnergySupply' })}
                                            </header>
                                        </Grid>
                                    </Grid>
                                </React.Fragment>
                                <Grid
                                        ...
                                        <Typography>
                                            <ul style={{ listStyle: 'disc' }} className="overviewText">
                                                <li className="listItem">
                                                    {t('box1Text1', { ns: 'rEnergySupply' })}
                                                </li>
                                                <li className="listItem">
                                                    {t('box1Text2', { ns: 'rEnergySupply' })}
                                                </li>
                                                <li className="listItem">
                                                    {t('box1Text3', { ns: 'rEnergySupply' })}
                                                </li>
                                            </ul>
                                        </Typography>
                                    </Grid>
                                    <Grid item xs={12} md={4} className={classes.arrowTextContainer}>
                                        <p className={classes.carouselArrowText}> <ArrowForwardIcon className={classes.arrowIcon} />
                                            {t('box1subheader1', { ns: 'rEnergySupply' })}
                                        </p>
                                        <p className={classes.carouselText}>
                                            <small>
                                                {t('box1Text4', { ns: 'rEnergySupply' })}
                                            </small></p>
                                        <br></br>
                                        <p className={classes.carouselArrowText}> <ArrowForwardIcon className={classes.arrowIcon} />
                                            {t('box1subheader2', { ns: 'rEnergySupply' })}
                                        </p>
                                        <p className={classes.carouselText}>
                                            <small>
                                                {t('box1Text5', { ns: 'rEnergySupply' })}
                                            </small></p>
                                    </Grid>
                                </Grid>
                            </div>
                                ...
                                <Grid
                                    ...
                                    <Grid item xs={12} sm={12} id="id1" >
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${PowerGridImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingEnergySupplyPowerGrid");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                                ...
                                                <Grid item sm={9}>
                                                    <Typography className={classes.themePaperTitle}>
                                                        ...
                                                        {t('box2Header1', { ns: 'rEnergySupply' })}
                                                    </Typography>
                                                </Grid>
                                    ...
                                    <Grid item xs={12} sm={12} id="id2" >
                                        <Paper
                                            ...
                                            onClick={() => {
                                                redirectTo("retrofittingEnergySupplyGenerator");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                                ...
                                                <Grid item sm={9}>
                                                    <Typography className={classes.themePaperTitle}>
                                                        ...
                                                        {t('box3Header1', { ns: 'rEnergySupply' })}
                                                    </Typography>
                                                </Grid>
...
export default RetrofittingEnergySupplyOptions;