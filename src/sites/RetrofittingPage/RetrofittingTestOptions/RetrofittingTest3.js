        ...
        <div className={classes.root}>
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">Not recommended retrofit measure</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
            <Grid container justify="center">
                <Paper className={classes.paper}>
                    <div className={classes.recommendationContainer} style={{ backgroundColor: Colors.notRecommendedRed, borderColor: "red" }}>
                        <React.Fragment>
                            <Grid
                                container
                                direction="row"
                                ...
                                <Grid item>
                                    <header className="overviewTitle" style={{ color: "red" }}>Not recommended for you</header>
                                </Grid>
                            </Grid>
                        </React.Fragment>
                        <Typography>
                            <div className="overviewText">
                                <p>This retrofit measure is not recommended for you because ...</p>
                                <p> 
                            ...
                            <Grid
                                ...
                                <Grid item sm={11} lg={9}>
                                    <p className="baseText">
                                        A conventional system of radiators designed to operate at a low temperature (30°C to 55°C).
                                    </p>
                                </Grid>
