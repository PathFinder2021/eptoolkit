...
import { overviewTitleContainer } from '../../../components/Styles/classes';
...
const RetrofittingSpaceHeatingRadiatorsHigh = () => {
    ...
    const [performanceValue, setPerformanceValue] = React.useState(3);
    ...
    var conditionYardValues =
    {
        0: "--",
        1: "There's water underneath the building. (ventilation space)",
        2: "The ground is skewed to the buildings. The floor level is lower than the outer side of the ground.",
        4: "Vegetation have not been cut off beside from the buildings' edges",
        7: "The ground clearly skewed away from the buildings",
    };

    const [selectedValue1, setConditionYard] = useState("test hh");


    const handleSliderChange = name => (event, newValue1) => {
        ...
        <div className={classes.root}>
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">Recommended retrofit measure</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
            <Grid container justify="center">
                <Paper className={classes.paper}>
                    <div className={classes.recommendationContainer} style={{ backgroundColor: Colors.recommendedGreen, borderColor: "green" }}>
                        <React.Fragment>
                            <Grid
                                container
                                direction="row"
                                ...
                                <Grid item style={{ margin: 10, marginLeft: 43, textAlign: "center", verticalAlign: 'middle', }}>
                                ...
                                <Grid item>
                                    <header className="overviewTitle" style={{ color: "green" }}>Recommended for you</header>
                                </Grid>
                            </Grid>
                        </React.Fragment>
                        <Typography>
                            <div className="overviewText">
                                <p>This retrofit measure is recommended for you because ...</p>
                                <p> 
                    ...
                    <Grid
                        ...
                        <Grid item xs={12}>
                            <Button onClick={() => setSelectedValue(0)}>Value 0</Button>
                            <Button onClick={() => handleValueChange(1)}>Value 1</Button>
                            <Button onClick={() => handleValueChange(2)}>Value 2</Button>
                            <Button onClick={() => handleValueChange(3)}>Value 3</Button>
                            <Button onClick={() => handleValueChange(4)}>Value 4</Button>
                        </Grid>
                            ...
                            <Grid
                                ...
                                <Grid item sm={11} lg={9}>
                                    <p className="baseText">
                                        A conventional system of radiators designed to operate at a high temperature (60°C to 80°C).
                                    </p>
                                </Grid>
...
export default RetrofittingSpaceHeatingRadiatorsHigh;