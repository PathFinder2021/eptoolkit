...
import BannerImage from "../../../external/images/walls/exteriorWallChangingInsulation.JPG"
...
const RetrofittingWallsStoneAddInsulation = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box2Header1', { ns: 'rWalls' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('addingInsulationSTab2text1', { ns: 'rWalls' })}
                            </p>
                        </TabPanel>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('addingInsulationSHeader1text1', { ns: 'rWalls' })}</p>
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('addingInsulationSHeader2text1', { ns: 'rWalls' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('addingInsulationSHeader3text1', { ns: 'rWalls' })}</p>
                                <p className="overviewText">{t('addingInsulationSHeader3text2', { ns: 'rWalls' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('addingInsulationSHeader4text1', { ns: 'rWalls' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('addingInsulationSRelatedLink1', { ns: 'rWalls' })}
...
export default RetrofittingWallsStoneAddInsulation;