...
const RetrofittingWallsWoodAddInsulationOutside = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box4Header1', { ns: 'rWalls' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('addingInsulationWOutsideTab2text1', { ns: 'rWalls' })}
                            </p>
                        </TabPanel>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('addingInsulationWOutsideHeader1text1', { ns: 'rWalls' })}</p>
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('addingInsulationWOutsideHeader2text1', { ns: 'rWalls' })}</p>
                                <p className="overviewText">{t('addingInsulationWOutsideHeader2text2', { ns: 'rWalls' })}</p>
                                <p className="overviewText">{t('addingInsulationWOutsideHeader2text3', { ns: 'rWalls' })}</p>
                                <p className="overviewText">{t('addingInsulationWOutsideHeader2text4', { ns: 'rWalls' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('addingInsulationWOutsideHeader3text1', { ns: 'rWalls' })}</p>
                                <p className="overviewText">{t('addingInsulationWOutsideHeader3text2', { ns: 'rWalls' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('addingInsulationWOutsideHeader4text1', { ns: 'rWalls' })}</p>
                                <p className="overviewText">{t('addingInsulationWOutsideHeader4text2', { ns: 'rWalls' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('addingInsulationWOutsideRelatedLink1', { ns: 'rWalls' })}
...
export default RetrofittingWallsWoodAddInsulationOutside;