...
import BannerImage from "../../../external/images/walls/hempWallInsulation1.jpeg"
import HempInsulationImage1 from "../../../external/images/walls/hempWallInsulation2.jpeg"
import HempInsulationImage2 from "../../../external/images/walls/hempLime.jpeg"
...
const RetrofittingWallsWoodChangeInsulation = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box6Header1', { ns: 'rWalls' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('changingInsulationWTab2text1', { ns: 'rWalls' })}
                            </p>
                        </TabPanel>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('changingInsulationWHeader1text1', { ns: 'rWalls' })}</p>
                                <img className="retrofitImage" src={HempInsulationImage1} width="50%" height="auto" />
                                <img className="retrofitImage" src={HempInsulationImage2} width="50%" height="auto" />
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('changingInsulationWHeader2text1', { ns: 'rWalls' })}</p>
                                <p className="overviewText">{t('changingInsulationWHeader2text2', { ns: 'rWalls' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('changingInsulationWHeader3text1', { ns: 'rWalls' })}</p>
                                <p className="overviewText">{t('changingInsulationWHeader3text2', { ns: 'rWalls' })}</p>
                                <p className="overviewText">{t('changingInsulationWHeader3text3', { ns: 'rWalls' })}</p>
                                <p className="overviewText">{t('changingInsulationWHeader3text4', { ns: 'rWalls' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('changingInsulationWHeader4text1', { ns: 'rWalls' })}</p>
                                <p className="overviewText">{t('changingInsulationWHeader4text2', { ns: 'rWalls' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('changingInsulationWRelatedLink1', { ns: 'rWalls' })}
...
export default RetrofittingWallsWoodChangeInsulation;