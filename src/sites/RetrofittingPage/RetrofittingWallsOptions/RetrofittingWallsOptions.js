...
import BannerImage from "../../../external/images/fullBuilding_or_wideScene/TEST0.jpg"
import BackgroundImage from "../../../external/images/windows/window2.JPG"
import HempInsulationImage from "../../../external/images/walls/hempWallInsulation1.jpeg"
import ChangingInsulationImage from "../../../external/images/walls/exteriorWallChangingInsulation.JPG"
...
const RetrofittingWallsOptions = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('header1', { ns: 'rWalls' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                                ...
                                <Grid
                                    ...
                                    <Typography>
                                            <ul style={{ listStyle: 'disc' }} className="overviewText">
                                                <li className="listItem"><h2>About walls</h2> </li>
                                            </ul>
                                        </Typography>
                                    </Grid>
                                    <Grid item xs={12} md={4} className={classes.arrowTextContainer}>
                                        <p className={classes.carouselArrowText}> <ArrowForwardIcon className={classes.arrowIcon} /> Altering and replacing walls </p>
                                        <p className={classes.carouselText}>
                                            <small>Improving the energy performance of the actual walls can be effective but isn't always heritage-sensitive.</small></p>
                                ...
                                <Grid
                                    ...
                                    <Grid item xs={12} sm={12} id="id1" >
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${ChangingInsulationImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingWallsStoneAddInsulation");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id2" >
                                        <Paper
                                            ...
                                            onClick={() => {
                                                redirectTo("retrofittingWallsStoneAirPassage");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id3" >
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${BackgroundImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingWallsWoodAddInsulationOutside");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id4" >
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${BackgroundImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingWallsWoodAddInsulationInside");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id5" >
                                        <Paper
                                            className={classes.themePaper}
                                            style={{ backgroundImage: `url(${HempInsulationImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingWallsWoodChangeInsulation");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id6" >
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${BackgroundImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingWallsTape");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
...
export default RetrofittingWallsOptions;