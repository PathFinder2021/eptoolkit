                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">High-performance wall insulation systems for external application</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                                ...
                                <Tab className={classes.tabStyle} label={
                                    <React.Fragment>
                                        <Grid
                                            ...
                                            className={classes.tabContainer}>
                                            <Grid item sm={10} md={5} lg={3}>
                                                <ThumbUpIcon className={classes.tabIcon} style={{ color: "green" }} />
                                            </Grid>
                                            <Grid item sm={11} md={7} lg={9}>
                                                <p className={classes.tabTitle}> Recommended retrofit measure </p>
                                            </Grid>
                                        </Grid>
...
export default RetrofitMeasure1;