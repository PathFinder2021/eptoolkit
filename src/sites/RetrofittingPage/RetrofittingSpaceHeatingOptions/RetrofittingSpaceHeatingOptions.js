...
import BannerImage from "../../../external/images/heating/TEST3.jpg"
...
import StoveImage from "../../../external/images/heating/woodStove.jpeg"
import HeatPumpImage from "../../../external/images/heating/airWaterHeatPumpExternal.jpeg"
import DistrictHeatingImage from "../../../external/images/heating/districtHeating.jpeg"
import UnderfloorHeatingImage from "../../../external/images/heating/lightweightUnderfloorHeat.jpeg"
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('header1', { ns: 'rHeating' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
            <Grid container justify="center">
                <Paper className={classes.paper}>
                                ...
                                <Grid
                                        ...
                                        <Typography>
                                            <ul style={{ listStyle: 'disc' }} className="overviewText">
                                                <li className="listItem">
                                                    {t('box1Text1', { ns: 'rHeating' })}
                                                </li>
                                                <li className="listItem">
                                                    {t('box1Text2', { ns: 'rHeating' })}
                                                </li>
                                                <li className="listItem">
                                                    {t('box1Text3', { ns: 'rHeating' })}
                                                </li>
                                            </ul>
                                        </Typography>
                                    </Grid>
                                    <Grid item xs={12} md={4} className={classes.arrowTextContainer}>
                                        <p className={classes.carouselArrowText}> <ArrowForwardIcon className={classes.arrowIcon} />
                                            {t('box1subheader1', { ns: 'rHeating' })}
                                        </p>
                                        <p className={classes.carouselText}>
                                            <small>
                                                {t('box1Text4', { ns: 'rHeating' })}
                                            </small></p>
                                        <br></br>
                                        <p className={classes.carouselArrowText}> <ArrowForwardIcon className={classes.arrowIcon} />
                                            {t('box1subheader2', { ns: 'rHeating' })}
                                        </p>
                                        <p className={classes.carouselText}>
                                            <small>
                                                {t('box1Text5', { ns: 'rHeating' })}
                                            </small>
                                        </p>
                                    </Grid>
                                </Grid>
                    ...
                    <Grid
                        ...
                        <Grid item xs={12} style={{ marginTop: "-1.7rem", marginBottom: "1.7rem" }} className={classes.infoText2}>
                            <p>
                                ...
                                <Grid
                                    ...
                                    <Grid item xs={12} sm={12} id="id1" >
                                        <Paper
                                            ...
                                            onClick={() => {
                                                redirectTo("retrofittingSpaceHeatingAirSource");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id2">
                                        <Paper
                                            className={classes.themePaper}
                                            style={{ backgroundImage: `url(${DistrictHeatingImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingSpaceHeatingDistrict");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id3" >
                                        <Paper
                                            ...
                                            onClick={() => {
                                                redirectTo("retrofittingSpaceHeatingRadiatorsHigh");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id4">
                                        <Paper
                                            ...
                                            onClick={() => {
                                                redirectTo("retrofittingSpaceHeatingRadiatorsLow");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id5">
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${BackgroundImage2})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingSpaceHeatingWarmAir");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id6">
                                        <Paper
                                            className={classes.themePaper}
                                            style={{ backgroundImage: `url(${UnderfloorHeatingImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingSpaceHeatingUnderfloor");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id7">
                                        <Paper
                                            ...
                                            onClick={() => {
                                                redirectTo("retrofittingSpaceHeatingStove");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
