                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box4Header1', { ns: 'rHeating' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('radHighTab2text1', { ns: 'rHeating' })}
                            </p>
                        </TabPanel>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('radHighHeader1text1', { ns: 'rHeating' })}</p>
                                <p className="overviewText">{t('radHighHeader1text2', { ns: 'rHeating' })}</p>
                                <p className="overviewText">{t('radHighHeader1text3', { ns: 'rHeating' })}</p>
                                <p className="overviewText">{t('radHighHeader1text4', { ns: 'rHeating' })}</p>
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('radHighHeader2text1', { ns: 'rHeating' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('radHighHeader3text1', { ns: 'rHeating' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('radHighHeader4text1', { ns: 'rHeating' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('radHighRelatedLink1', { ns: 'rHeating' })}
