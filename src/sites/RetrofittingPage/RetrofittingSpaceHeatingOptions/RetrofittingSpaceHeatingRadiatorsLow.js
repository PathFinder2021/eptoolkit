...
const RetrofittingSpaceHeatingRadiatorsLow = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box5Header1', { ns: 'rHeating' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('radLowHeader1text1', { ns: 'rHeating' })}</p>
                                <p className="overviewText">{t('radLowHeader1text2', { ns: 'rHeating' })}</p>
                                <p className="overviewText">{t('radLowHeader1text3', { ns: 'rHeating' })}</p>
                                <p className="overviewText">{t('radLowHeader1text4', { ns: 'rHeating' })}</p>
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('radLowHeader2text1', { ns: 'rHeating' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('radLowHeader3text1', { ns: 'rHeating' })}</p>
                                <p className="overviewText">{t('radLowHeader3text2', { ns: 'rHeating' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('radLowHeader4text1', { ns: 'rHeating' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('radLowRelatedLink1', { ns: 'rHeating' })}
...
export default RetrofittingSpaceHeatingRadiatorsLow;