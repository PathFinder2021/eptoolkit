...
import BannerImage from "../../../external/images/heating/districtHeating.jpeg"
...
const RetrofittingSpaceHeatingDistrict = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box3Header1', { ns: 'rHeating' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                                ...
                                <Tab className={classes.tabStyle} style={{ borderLeft: "0px solid" }} label={
                                    <React.Fragment>
                                        <Grid
                                            ...
                                            <Grid item sm={11} md={7} lg={9} className={classes.tabTitle}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('districtHeatingTab2text1', { ns: 'rHeating' })}
                            </p>
                        </TabPanel>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('districtHeatingHeader1text1', { ns: 'rHeating' })}</p>
                                <p className="overviewText">{t('districtHeatingHeader1text2', { ns: 'rHeating' })}</p>
                                <p className="overviewText">{t('districtHeatingHeader1text3', { ns: 'rHeating' })}</p>
                                <p className="overviewText">
                                    <ul style={{ listStyle: 'disc', listStylePosition: "inside", marginTop: "0", marginBottom: "0" }}>
                                        <li className="listItem">
                                            {t('districtHeatingHeader1text4', { ns: 'rHeating' })}
                                        </li>
                                        <li className="listItem">
                                            {t('districtHeatingHeader1text5', { ns: 'rHeating' })}
                                        </li>
                                        <li className="listItem">
                                            {t('districtHeatingHeader1text6', { ns: 'rHeating' })}
                                        </li>
                                    </ul>
                                </p>
                                <p className="overviewText">{t('districtHeatingHeader1text7', { ns: 'rHeating' })}</p>
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('districtHeatingHeader2text1', { ns: 'rHeating' })}</p>
                            </Grid>

                            <Grid item id="id3">
                                <header className="retrofitHeader">
                                    <b>
                                        {t('header3', { ns: 'rOptionsGen' })}
                                    </b>
                                </header>
                                <p className="overviewText">{t('districtHeatingHeader3text1', { ns: 'rHeating' })}</p>
                                <p className="overviewText">{t('districtHeatingHeader3text2', { ns: 'rHeating' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('districtHeatingHeader4text1', { ns: 'rHeating' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('districtHeatingRelatedLink1', { ns: 'rHeating' })}
...
export default RetrofittingSpaceHeatingDistrict;