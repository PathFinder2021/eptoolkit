...
import BannerImage from "../../../external/images/heating/lightweightUnderfloorHeat.jpeg"
import UnderfloorHeatingImage1 from "../../../external/images/heating/lightwtUnderflrHeatConductorPlates.jpeg"
import UnderfloorHeatingImage2 from "../../../external/images/heating/underfloorHeatingCoils.jpeg"
...
const RetrofittingSpaceHeatingUnderfloor = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box7Header1', { ns: 'rHeating' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('underfloorTab2text1', { ns: 'rHeating' })}
                            </p>
                        </TabPanel>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('underfloorHeader1text1', { ns: 'rHeating' })}</p>
                                <img className="retrofitImage" src={UnderfloorHeatingImage1} width="50%" height="auto" />
                                <img className="retrofitImage" src={UnderfloorHeatingImage2} width="50%" height="auto" />
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('underfloorHeader2text1', { ns: 'rHeating' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('underfloorHeader3text1', { ns: 'rHeating' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('underfloorHeader4text1', { ns: 'rHeating' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('underfloorRelatedLink1', { ns: 'rHeating' })}
...
export default RetrofittingSpaceHeatingUnderfloor;