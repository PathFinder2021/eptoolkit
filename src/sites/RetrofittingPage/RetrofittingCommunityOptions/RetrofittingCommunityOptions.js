                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('header1', { ns: 'rCommunity' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                                ...
                                <Grid
                                        ...
                                        <Typography>
                                            <ul style={{ listStyle: 'disc' }} className="overviewText">
                                                <li className="listItem">
                                                    {t('box1Text1', { ns: 'rCommunity' })}
                                                </li>
                                                <li className="listItem">
                                                    {t('box1Text2', { ns: 'rCommunity' })}
                                                </li>
                                                <li className="listItem">
                                                    {t('box1Text3', { ns: 'rCommunity' })}
                                                </li>
                                            </ul>
                                        </Typography>
                                    </Grid>
                                    <Grid item xs={12} md={4} className={classes.arrowTextContainer}>
                                        <p className={classes.carouselArrowText}> <ArrowForwardIcon className={classes.arrowIcon} />
                                            {t('box1subheader1', { ns: 'rCommunity' })}
                                        </p>
                                        <p className={classes.carouselText}>
                                            <small>
                                                {t('box1Text4', { ns: 'rCommunity' })}
                                            </small></p>
                                        <br></br>
                                        <p className={classes.carouselArrowText}> <ArrowForwardIcon className={classes.arrowIcon} />
                                            {t('box1subheader2', { ns: 'rCommunity' })}
                                        </p>
                                        <p className={classes.carouselText}>
                                            <small>
                                                {t('box1Text5', { ns: 'rCommunity' })}
                                            </small></p>
                                    </Grid>
                                </Grid>
                            </div>
                                ...
                                <Grid
                                    ...
                                    <Grid item xs={12} sm={12} id="id1" >
                                        <Paper
                                            ...
                                            onClick={() => {
                                                redirectTo("retrofittingCodesign");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
