...
const RetrofittingEnergyGenerationMicrohydro = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box2Header1', { ns: 'rCommunity' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('codesignTab2text1', { ns: 'rCommunity' })}
                            </p>
                        </TabPanel>
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">
                                    {t('codesignHeader1text1', { ns: 'rCommunity' })}
                                </p>
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>{t('header2', { ns: 'rOptionsGen' })}</b>
                                </header>
                                <p className="overviewText">{t('codesignHeader2text1', { ns: 'rCommunity' })}</p>
                                <p className="overviewText">{t('codesignHeader2text2', { ns: 'rCommunity' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('codesignHeader3text1', { ns: 'rCommunity' })}</p>
                                <p className="overviewText">{t('codesignHeader3text2', { ns: 'rCommunity' })}</p>
                                <p className="overviewText">{t('codesignHeader3text3', { ns: 'rCommunity' })}</p>
                            </Grid>

                            <Grid item id="id4">
                                <header className="retrofitHeader">
                                    <b>{t('header4', { ns: 'rOptionsGen' })}</b>
                                </header>
                                <p className="overviewText">{t('codesignHeader4text1', { ns: 'rCommunity' })}</p>
                                <p className="overviewText">{t('codesignHeader4text2', { ns: 'rCommunity' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('codesignRelatedLink1', { ns: 'rCommunity' })}
...
export default RetrofittingEnergyGenerationMicrohydro;