...
import BannerImage from "../../../external/images/energy/solarPanels1.JPG"
import WindTurbineImage from "../../../external/images/energy/windTurbine1.JPG"
import WaterWheelImage from "../../../external/images/energy/peltonWheelWaterTurbine.jpeg" 
import SolarPanelImage from "../../../external/images/energy/solarHotWaterFlatPlate.jpeg" 
import BiomassBoilerImage from "../../../external/images/energy/biomassBoiler_BufferTank.jpeg"
import BiomassCanolaFuelImage from "../../../external/images/energy/biomassFuelCanolaBales.jpeg"
...
const RetrofittingEnergyGenerationOptions = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('header1', { ns: 'rEnergyGen' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                                ...
                                <Grid
                                        ...
                                        <Typography>
                                            <ul style={{ listStyle: 'disc' }} className="overviewText">
                                                <li className="listItem">
                                                    {t('box1Text1', { ns: 'rEnergyGen' })}
                                                </li>
                                                <li className="listItem">
                                                    {t('box1Text2', { ns: 'rEnergyGen' })}
                                                </li>
                                                <li className="listItem">
                                                    {t('box1Text3', { ns: 'rEnergyGen' })}
                                                </li>
                                            </ul>
                                        </Typography>
                                    </Grid>
                                    <Grid item xs={12} md={4} className={classes.arrowTextContainer}>
                                        <p className={classes.carouselArrowText}> <ArrowForwardIcon className={classes.arrowIcon} />
                                            {t('box1subheader1', { ns: 'rEnergyGen' })}
                                        </p>
                                        <p className={classes.carouselText}>
                                            <small>
                                                {t('box1Text4', { ns: 'rEnergyGen' })}
                                            </small></p>
                                        <br></br>
                                        <p className={classes.carouselArrowText}> <ArrowForwardIcon className={classes.arrowIcon} />
                                            {t('box1subheader2', { ns: 'rEnergyGen' })}
                                        </p>
                                        <p className={classes.carouselText}>
                                            <small>
                                                {t('box1Text5', { ns: 'rEnergyGen' })}
                                            </small></p>
                                    </Grid>
                                </Grid>
                            </div>
                                ...
                                <Grid
                                    ...
                                    <Grid item xs={12} sm={12} id="id1" >
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${WaterWheelImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingEnergyGenerationMicrohydro");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id2" >
                                        <Paper
                                            ...
                                            onClick={() => {
                                                redirectTo("retrofittingEnergyGenerationWindTurbine");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id3" >
                                        <Paper
                                            ...
                                            onClick={() => {
                                                redirectTo("retrofittingEnergyGenerationSolarPanels");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id4" >
                                        <Paper
                                            className={classes.themePaper}
                                            style={{ backgroundImage: `url(${BiomassBoilerImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingEnergyGenerationBiomassDigester");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id5" >
                                        <Paper
                                            className={classes.themePaper}
                                            style={{ backgroundImage: `url(${BiomassCanolaFuelImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingEnergyGenerationBiomassHeatGeneration");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
...
export default RetrofittingEnergyGenerationOptions;