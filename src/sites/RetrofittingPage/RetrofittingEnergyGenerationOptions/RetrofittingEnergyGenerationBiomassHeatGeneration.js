...
import BannerImage from "../../../external/images/energy/biomassFuelCanolaBales.jpeg"
import BiomassImage from "../../../external/images/energy/biomassFuelCanola.jpeg"
...
const RetrofittingEnergyGenerationBiomassHeatGeneration = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box6Header1', { ns: 'rEnergyGen' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('biomassHeatGenerationTab2text1', { ns: 'rEnergyGen' })}
                            </p>
                        </TabPanel>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('biomassHeatGenerationHeader1text1', { ns: 'rEnergyGen' })}</p>
                                <img className="retrofitImage" src={BiomassImage} width="50%" height="auto" />
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('biomassHeatGenerationHeader2text1', { ns: 'rEnergyGen' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('biomassHeatGenerationHeader3text1', { ns: 'rEnergyGen' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('biomassHeatGenerationHeader4text1', { ns: 'rEnergyGen' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('biomassHeatGenerationRelatedLink1', { ns: 'rEnergyGen' })}
...
export default RetrofittingEnergyGenerationBiomassHeatGeneration;