...
import BannerImage from "../../../external/images/energy/solarHotWaterFlatPlate.jpeg"
import SolarPanelImage from "../../../external/images/energy/PVpanels.jpeg"
...
const RetrofittingEnergyGenerationSolarPanels = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box4Header1', { ns: 'rEnergyGen' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('solarPanelsTab2text1', { ns: 'rEnergyGen' })}
                            </p>
                        </TabPanel>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('solarPanelsHeader1text1', { ns: 'rEnergyGen' })}</p>
                                <img className="retrofitImage" src={SolarPanelImage} width="30%" height="auto" />
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('solarPanelsHeader2text1', { ns: 'rEnergyGen' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('solarPanelsHeader3text1', { ns: 'rEnergyGen' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('solarPanelsHeader4text1', { ns: 'rEnergyGen' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('solarPanelsRelatedLink1', { ns: 'rEnergyGen' })}
...
export default RetrofittingEnergyGenerationSolarPanels;