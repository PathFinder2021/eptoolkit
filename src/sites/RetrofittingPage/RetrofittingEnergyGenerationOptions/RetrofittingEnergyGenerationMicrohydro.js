...
import BannerImage from "../../../external/images/energy/peltonWheelWaterTurbine.jpeg"
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box2Header1', { ns: 'rEnergyGen' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('hydroTurbineTab2text1', { ns: 'rEnergyGen' })}
                            </p>
                        </TabPanel>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('hydroTurbineHeader1text1', { ns: 'rEnergyGen' })}</p>
                                <p className="overviewText">{t('hydroTurbineHeader1text2', { ns: 'rEnergyGen' })}</p>
                                <p className="overviewText">{t('hydroTurbineHeader1text3', { ns: 'rEnergyGen' })}</p>
                                <p className="overviewText">{t('hydroTurbineHeader1text4', { ns: 'rEnergyGen' })}</p>
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('hydroTurbineHeader2text1', { ns: 'rEnergyGen' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('hydroTurbineHeader3text1', { ns: 'rEnergyGen' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('hydroTurbineHeader4text1', { ns: 'rEnergyGen' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('hydroTurbineRelatedLink1', { ns: 'rEnergyGen' })}
