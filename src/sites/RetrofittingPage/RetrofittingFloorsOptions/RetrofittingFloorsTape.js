                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box7Header1', { ns: 'rFloors' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('tapingVBarrierTab2text1', { ns: 'rFloors' })}
                            </p>
                        </TabPanel>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('tapingVBarrierHeader1text1', { ns: 'rFloors' })}</p>
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('tapingVBarrierHeader2text1', { ns: 'rFloors' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('tapingVBarrierHeader3text1', { ns: 'rFloors' })}</p>
                                <p className="overviewText">{t('tapingVBarrierHeader3text2', { ns: 'rFloors' })}</p>
                                <p className="overviewText">{t('tapingVBarrierHeader3text3', { ns: 'rFloors' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('tapingVBarrierHeader4text1', { ns: 'rFloors' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('tapingVBarrierRelatedLink1', { ns: 'rFloors' })}
...
export default RetrofittingFloorsTape;