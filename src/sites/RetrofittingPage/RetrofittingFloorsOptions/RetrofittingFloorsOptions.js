...
const RetrofittingFloorsOptions = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('header1', { ns: 'rFloors' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                                    ...
                                    <Grid item xs={12} md={8}>
                                        <Typography>
                                            <ul style={{ listStyle: 'disc' }} className="overviewText">
                                                <li className="listItem"><h2>About floors</h2> </li>
                                            </ul>
                                        </Typography>
                                    </Grid>
                                    <Grid item xs={12} md={4} className={classes.arrowTextContainer}>
                                        <p className={classes.carouselArrowText}> <ArrowForwardIcon className={classes.arrowIcon} /> Altering and replacing floors </p>
                                        <p className={classes.carouselText}>
                                            <small>Improving the energy performance of the actual floors can be effective but isn't always heritage-sensitive.</small></p>
                                ...
                                <Grid
                                    ...
                                    <Grid item xs={12} sm={12} id="id1" >
                                        <Paper
                                            ...
                                            onClick={() => {
                                                redirectTo("retrofittingFloorsCrawlSpaceAddInsulation");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id2" >
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${BackgroundImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingFloorsCrawlSpaceChangeInsulation");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id3" >
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${BackgroundImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingFloorsCrawlSpaceImpressedInsulation");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id4" >
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${BackgroundImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingFloorsChangeInsulationSoG");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id5" >
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${BackgroundImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingFloorsImprovingGFG");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                    ...
                                    <Grid item xs={12} sm={12} id="id6" >
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${BackgroundImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingFloorsTape");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
...
export default RetrofittingFloorsOptions;