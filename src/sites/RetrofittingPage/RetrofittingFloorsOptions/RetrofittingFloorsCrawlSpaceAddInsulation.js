...
const RetrofittingFloorsCrawlSpaceAddInsulation = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box2Header1', { ns: 'rFloors' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('addingInsulationTab2text1', { ns: 'rFloors' })}
                            </p>
                        </TabPanel>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('addingInsulationHeader1text1', { ns: 'rFloors' })}</p>
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('addingInsulationHeader2text1', { ns: 'rFloors' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('addingInsulationHeader3text1', { ns: 'rFloors' })}</p>
                                <p className="overviewText">{t('addingInsulationHeader3text2', { ns: 'rFloors' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('addingInsulationHeader4text1', { ns: 'rFloors' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('addingInsulationRelatedLink1', { ns: 'rFloors' })}
...
export default RetrofittingFloorsCrawlSpaceAddInsulation;