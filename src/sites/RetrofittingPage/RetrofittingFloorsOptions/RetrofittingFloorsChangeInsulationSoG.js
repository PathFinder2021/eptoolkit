...
const RetrofittingFloorsChangeInsulationSoG = () => {
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('box5Header1', { ns: 'rFloors' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.tabPanelBase}>
                        ...
                        <TabPanel className={classes.tabPanel} value={value} index={1}>
                            <p className="baseText">
                                {t('changingInsulationSoGTab2text1', { ns: 'rFloors' })}
                            </p>
                        </TabPanel>
                    ...
                    <Grid
                        ...
                        <Grid item md={12} lg={9} xl={10} container direction="column">
                            ...
                            <Grid item>
                                <p className="overviewText">{t('changingInsulationSoGHeader1text1', { ns: 'rFloors' })}</p>
                            </Grid>
                            <Grid item id="id2">
                                <header className="retrofitHeader">
                                    <b>
                                ...
                                <p className="overviewText">{t('changingInsulationSoGHeader2text1', { ns: 'rFloors' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id3">
                                ...
                                <p className="overviewText">{t('changingInsulationSoGHeader3text1', { ns: 'rFloors' })}</p>
                                <p className="overviewText">{t('changingInsulationSoGHeader3text2', { ns: 'rFloors' })}</p>
                                <p className="overviewText">{t('changingInsulationSoGHeader3text3', { ns: 'rFloors' })}</p>
                                <p className="overviewText">{t('changingInsulationSoGHeader3text4', { ns: 'rFloors' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id4">
                                ...
                                <p className="overviewText">{t('changingInsulationSoGHeader4text1', { ns: 'rFloors' })}</p>
                            </Grid>
                            ...
                            <Grid item id="id5">
                                ...
                                <p className="overviewText">
                                        ...
                                        {t('changingInsulationSoGRelatedLink1', { ns: 'rFloors' })}
...
export default RetrofittingFloorsChangeInsulationSoG;