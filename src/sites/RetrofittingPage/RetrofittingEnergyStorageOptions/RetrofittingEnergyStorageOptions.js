...
import BannerImage from "../../../external/images/energy/biogasReactor1.jpg"
import BackgroundImage from "../../../external/images/windows/window2.JPG"
import BiogasImage from "../../../external/images/energy/biogasReactor1.jpg"
import HotWaterImage from "../../../external/images/energy/solarHotWaterEvacuatedTube.jpeg"
                ...
                <Grid item xs={12} className={classes.banner}>
                    <Grid
                        ...
                        <Typography align="left">
                            <p className="bannerText">{t('header1', { ns: 'rEnergyStorage' })}</p>
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                                    ...
                                    <Grid
                                        ...
                                        <Grid item>
                                            <header className="overviewTitle">
                                                {t('box1Header1', { ns: 'rEnergyStorage' })}
                                            </header>
                                        </Grid>
                                    </Grid>
                                </React.Fragment>
                                <Grid
                                        ...
                                        <Typography>
                                            <ul style={{ listStyle: 'disc' }} className="overviewText">
                                                <li className="listItem">
                                                    {t('box1Text1', { ns: 'rEnergyStorage' })}
                                                </li>
                                                <li className="listItem">
                                                    {t('box1Text2', { ns: 'rEnergyStorage' })}
                                                </li>
                                                <li className="listItem">
                                                    {t('box1Text3', { ns: 'rEnergyStorage' })}
                                                </li>
                                            </ul>
                                        </Typography>
                                    </Grid>
                                    <Grid item xs={12} md={4} className={classes.arrowTextContainer}>
                                        <p className={classes.carouselArrowText}> <ArrowForwardIcon className={classes.arrowIcon} />
                                            {t('box1subheader1', { ns: 'rEnergyStorage' })}
                                        </p>
                                        <p className={classes.carouselText}>
                                            <small>
                                                {t('box1Text4', { ns: 'rEnergyStorage' })}
                                            </small></p>
                                        <br></br>
                                        <p className={classes.carouselArrowText}> <ArrowForwardIcon className={classes.arrowIcon} />
                                            {t('box1subheader2', { ns: 'rEnergyStorage' })}
                                        </p>
                                        <p className={classes.carouselText}>
                                            <small>
                                                {t('box1Text5', { ns: 'rEnergyStorage' })}
                                            </small></p>
                                    </Grid>
                                </Grid>
                            </div>
                                ...
                                <Grid
                                    ...
                                    <Grid item xs={12} sm={12} id="id1" >
                                        <Paper
                                            ...
                                            style={{ backgroundImage: `url(${BiogasImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingEnergyStorageBiogas");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                                ...
                                                <Grid item sm={9}>
                                                    <Typography className={classes.themePaperTitle}>
                                                        ...
                                                        {t('box2Header1', { ns: 'rEnergyStorage' })}
                                                    </Typography>
                                                </Grid>
                                    ...
                                    <Grid item xs={12} sm={12} id="id2" >
                                        <Paper
                                            className={classes.themePaper}
                                            style={{ backgroundImage: `url(${HotWaterImage})` }}
                                            onClick={() => {
                                                redirectTo("retrofittingEnergyStorageHotWater");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                                ...
                                                <Grid item sm={9}>
                                                    <Typography className={classes.themePaperTitle}>
                                                        ...
                                                        {t('box3Header1', { ns: 'rEnergyStorage' })}
                                                    </Typography>
                                                </Grid>
                                    ...
                                    <Grid item xs={12} sm={12} id="id3" >
                                        <Paper
                                            ...
                                            onClick={() => {
                                                redirectTo("retrofittingEnergyStorageBatteries");
                                            }}>
                                            <Grid
                                                container
                                                direction="row"
                                                ...
                                                <Grid item sm={9}>
                                                    <Typography className={classes.themePaperTitle}>
                                                        ...
                                                        {t('box4Header1', { ns: 'rEnergyStorage' })}
                                                    </Typography>
                                                </Grid>
